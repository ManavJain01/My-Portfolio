    ...
    <div className={`flex flex-col gap-20 py-48 pb-96`}>
      ...
      <div className="flex gap-10 items-center justify-center flex-wrap-reverse xl:flex-nowrap">
        <div className="flex flex-col items-center gap-10">
          {/* My Name */}
          <motion.p whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x:-100}} transition={{duration: 0.5}} className="flex items-center gap-2 md:gap-5">
          ...
          {/* Content */}
          <motion.p whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x:-100}} transition={{duration: 0.5, delay: 0.2}} className="text-2xl">A passionate Full Stack Developer 🚀 having an experience of building Web applications with Javascript / Reactjs / NodeJs and some other cool libraries and frameworks.</motion.p>

          {/* 2 Buttons */}
          <motion.section whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x:-100}} transition={{duration: 0.5, delay: 0.5}} className="w-full flex gap-5 justify-between items-center flex-wrap">
        ...
        <motion.img
          src={mine}
          alt="mine"
          whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x:200}} transition={{duration: 0.5}}
          className="hidden md:block h-[30rem] rounded-full" />
      </div>

      {/* Education */}
      <div className="flex flex-col gap-10">
        <motion.h1 whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x:-100}} transition={{duration: 0.5}} className="text-6xl font-semibold">Education</motion.h1>
        <Education />
      </div>
