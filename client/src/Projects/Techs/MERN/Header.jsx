...
function Header(){
  return(
    <div className="h-[20vh] bg-[linear-gradient(#b0c3f3,rgba(196,196,196,0))] text-blue-600 flex flex-col justify-center gap-5">
      <h1 className="font-bold text-5xl text-center w-fit mt-10 mx-auto px-3 pb-4 rounded-2xl shadow-reverse_clayMorphism hover:shadow-none hover:scale-[120%] duration-700">My MERN Projects</h1>
