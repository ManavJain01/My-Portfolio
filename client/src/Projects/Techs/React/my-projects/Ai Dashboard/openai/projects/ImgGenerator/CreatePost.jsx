    ...
    <section className="max-w-7xl mx-auto">
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex items-center gap-5'> 
            ...
            <p className='text-[#222629] text-[14px] inline'>Limit per reset: {count !== -1 ? <span>{count} / 5</span> : <span>Loading...</span>}</p>
        </div>
      ...
      <div className='mt-36'>
            ...
            <button className={`text-[#666e75] text-[14px] ml-3 ${!reset && "mb-2"}`} onClick={() => {setReset(!reset)}}>{reset ? "Cancel" : "Reset"}</button>
            <ToastContainer />
        </div>
        {
          reset && (
            <div className='mt-2'>
              ...
              <button
                type='button'
                className='text-white bg-[#5adbb5] hover:bg-[#5dbea3] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 mb-5 text-center mt-5'
