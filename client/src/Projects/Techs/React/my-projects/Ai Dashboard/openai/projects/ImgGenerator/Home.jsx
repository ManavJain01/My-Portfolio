...
export default function Home() {
  ...
  const RenderCards = ({ data, title }) => {
    if (data?.length > 0) return data.map((post, i) => <Card key={i} _id={post._id} name={post.name} prompt={post.prompt} photo={post.photo} love={post.love} onLoveUpdate={updateLoveCount} 
      />)
    return (
      <div>
