...
export default function Main() {
  ...
  return (
    <div className={`h-lvh p-10 sm:p-16 font-serif flex flex-col transition-all duration-1000 ${darkTheme ? "bg-black text-white" : "bg-gray-300 text-black"}`}>
      <div className={`flex-1 flex flex-col gap-10 justify-between border-2 rounded-lg shadow-2xl overflow-y-scroll scrollbar-none ${darkTheme ? "border-gray-900 shadow-gray-800" : "border-gray-300 shadow-gray-400"}`}>
        ...
        {/* Main Body */}
        <InnerMain ref={{bio, skills, certificates, projects, connect}} darkTheme={darkTheme} />
